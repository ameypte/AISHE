...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="container shadow rounded-5 px-5 py-3 bg-body-tertiary bg-opacity-50" style={{width:"37%"}}>
        <form onSubmit={handleSubmit}>          
          ...
          <h3 className="text-center text-danger mt-4">DATABASE LOGIN</h3>
          {message && (
            <>
              <svg
